This repository contains a scilab script to make a model of genes/proteins regulated by the circadian clock in neurospora mice, and a pdf report where the result are analyzed.
